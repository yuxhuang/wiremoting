...
\index{RMAuthenticator-\/p@{RMAuthenticator-\/p}!authenticateWithCall:@{authenticateWithCall:}}
\index{authenticateWithCall:@{authenticateWithCall:}!RMAuthenticator-p@{RMAuthenticator-\/p}}
\subsubsection[{authenticateWithCall:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (void) authenticateWithCall: ({\bf RMCall} $\ast$) {\em call}\hspace{0.3cm}{\ttfamily  \mbox{[}required\mbox{]}}}}
