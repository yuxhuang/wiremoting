...
\subsubsection[{authenticateResponseString:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (BOOL) authenticateResponseString: ({\bf NSString} $\ast$) {\em responseString}\hspace{0.3cm}{\ttfamily  \mbox{[}optional\mbox{]}}}}
